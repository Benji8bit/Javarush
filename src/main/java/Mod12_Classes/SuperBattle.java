...
public class SuperBattle {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 20; i++) {
            startNextRound(new BagoRap(), new UltraMetal1());
        }

        System.out.printf("По итогу 20-ти раундов побеждает... %s!!!", UltraMetal1.score > BagoRap.score ? "УЛЬТРАМЕТАААААЛ" : "БАГОРЭЭЭЭЭП");
    }

    public static void startNextRound(BagoRap rap, UltraMetal1 metal) {
